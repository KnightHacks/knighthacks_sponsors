...
func (ec *executionContext) __resolve_entities(ctx context.Context, representations []map[string]interface{}) []fedruntime.Entity {
	...
	resolveEntity := func(ctx context.Context, typeName string, rep map[string]interface{}, idx []int, i int) (err error) {
		...
		case "Sponsor":
			...
			if err != nil {
				return fmt.Errorf(`finding resolver for Entity "Sponsor": %w`, err)
			}
			switch resolverName {
			...
			case "findSponsorByID":
				...
				if err != nil {
					return fmt.Errorf(`unmarshalling param 0 for findSponsorByID(): %w`, err)
				}
				entity, err := ec.resolvers.Entity().FindSponsorByID(ctx, id0)
				if err != nil {
					return fmt.Errorf(`resolving Entity "Sponsor": %w`, err)
				}
...
func entityResolverNameForSponsor(ctx context.Context, rep map[string]interface{}) (string, error) {
	for {
		...
		return "findSponsorByID", nil
	}
	return "", fmt.Errorf("%w for Sponsor", ErrTypeNotFound)
}
